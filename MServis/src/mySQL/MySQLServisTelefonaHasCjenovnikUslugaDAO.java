...
public class MySQLServisTelefonaHasCjenovnikUslugaDAO implements ServisTelefonaHasCjenovnikUslugaDAO {
	...
	public boolean insert(ServisTelefonaHasCjenovnikUslugaDTO servisCjenovnik) {
		// TODO - implement MySQLServisTelefonaHasCjenovnikUslugaDAO.insert
	...
	public List<ServisTelefonaHasCjenovnikUslugaDTO> selectAll() {
		// TODO - implement MySQLServisTelefonaHasCjenovnikUslugaDAO.selectAll
		throw new UnsupportedOperationException();
	}
	 ...
	 */
	public List<ServisTelefonaHasCjenovnikUslugaDTO> selectBy(ServisTelefonaHasCjenovnikUslugaDTO servisCjenobnik) {
		// TODO - implement MySQLServisTelefonaHasCjenovnikUslugaDAO.selectBy
		throw new UnsupportedOperationException();
	}
